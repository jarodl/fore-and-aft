 ...
 *       Filename:  Pieces.h
 *
 *    Description:  Wrapper for the string of pieces for storing available
 *    moves.
 *
 *        Version:  1.0
...
class Pieces
{
  public:
    ...
    Pieces getCopyAndMakeNextMove()
    {
      Pieces nextState = Pieces(*this);
    ...
    // Function: getSize
    //
    // Desc: Returns the number of pieces.
    //
    // Pre: None.
    //
    // Post: The size of the pieces string is returned.
    int getSize() const
    {
      return values.size();
    }
    ...
    // Function: getValues
    //
    // Desc: Returns all of the pieces as a string.
    //
    // Pre: None.
    //
    ...
    // Function: getWidth
    //
    // Desc: Returns the width of the pieces. Really only used for the copy
    // constructor.
    //
    // Pre: None.
    //
    ...
    // Function: getHeight
    //
    // Desc: Returns the height of the pieces. Really only used for the copy
    // constructor.
    //
    // Pre: None.
    //
  ...
  private:
    ...
    // and left bounds. The bounds determine where possible pieces are that can
